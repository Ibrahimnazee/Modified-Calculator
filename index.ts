...
if (userQuestion.operator === "Addition") {
  console.log(
    chalk.bgGreen(userQuestion.firstNumber + userQuestion.secondNumber)
  );
} else if (userQuestion.operator === "Substraction") {
  console.log(
    chalk.bgMagenta(userQuestion.firstNumber - userQuestion.secondNumber)
  );
} else if (userQuestion.operator === "Multiplication") {
  console.log(
    chalk.bgCyan(userQuestion.firstNumber * userQuestion.secondNumber)
  );
} else if (userQuestion.operator === "Division") {
  console.log(
    chalk.bgRed(userQuestion.firstNumber / userQuestion.secondNumber)
  );
} else if (userQuestion.operator === "Exponentiation") {
  console.log(
    chalk.bgGreenBright(userQuestion.firstNumber ** userQuestion.secondNumber)
  );
